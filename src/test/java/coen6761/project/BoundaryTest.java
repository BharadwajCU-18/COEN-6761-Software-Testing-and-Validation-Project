...
class BoundaryTest {
    ...
    void testBoundaryStop(RobotMotion.Direction dir, int size, int expectedX, int expectedY) {
        ...
        e.state.facing = dir;
        // Move enough to hit boundary from (0,0) or initial placement
        // If moving south/west from (0,0), it should stay 0.
        // If moving north/east from (0,0), it should stop at size-1.
        e.move(100);
